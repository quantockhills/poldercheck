...
Regression anchor: "since the 2023 election" was parsed as a single-year 2023
query (the since-regex required the year adjacent to the anchor word), which
truncated retrieval at 2024-01-01 and starved the answer of post-election
evidence — caught by the RAGAS faithfulness metric (eval case 3, score 0.2).
"""
...
def test_no_year_defaults_to_last_five_years():
    f, t, _, buckets = parse_date_range(
        "Waar ging het debat over woningbouw de afgelopen maanden over?", TODAY
    )
